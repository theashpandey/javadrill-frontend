...
const SECTIONS = [
  ['Acceptance of Terms', 'By using AssessArc, you agree to these terms. AssessArc is an AI-powered interview preparation platform. Use of the platform is subject to these terms and our Privacy Policy.'],
  ['Service Description', 'AssessArc provides AI-powered role-based mock interviews using voice recognition and AI language models. The service is for educational and practice purposes only. We do not guarantee job placement or interview success.'],
  ...
  ['Acceptable Use', 'You may not use AssessArc to generate harmful content, abuse the platform, attempt to bypass payment or authentication, reverse-engineer the service, or violate applicable laws.'],
  ...
  ['Limitation of Liability', 'AssessArc is provided as is. We are not liable for interview outcomes, job results, provider outages, browser microphone issues, or indirect damages arising from use of the platform.'],
  ['Changes to Terms', 'We may update these terms. Continued use of AssessArc after changes constitutes acceptance of the updated terms.'],
];
