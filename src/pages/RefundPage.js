...
const SECTIONS = [
  ['Overview', 'AssessArc uses a credit-based system. Credits are purchased through Razorpay and used to start interview sessions.'],
  ...
  ['How to Request a Refund', 'Contact us through the Contact form on the homepage within 24 hours of purchase. Include your AssessArc account email, payment date, amount, and Razorpay payment ID if available.'],
